           ...
           <div className="i-assignment-container">
               ...
               <div>
                   <div className="i-notify-image-box">
                       <img src="./chaula-man.png" className="i-assignment-image"/>
                   ...
                   <div className="i-assignment-body">
                       <Link to="https://localhost:3000" className="i-assignment-link">
                           ...
                           Assignment.pdf</Link>
                       <textarea className="i-textarea" rows={10}>
